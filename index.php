...
<html lang="id">
	...
	<body>
		<nav class="navbar navbar-inverse navbar-static-top">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="index.php">ROCS </a>
				</div>
				...
				<div class="collapse navbar-collapse" id="myNavbar">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="?page=kontak">Anggota</a></li>
						<li><a href="?page=bantuan">Agenda</a></li>
		...
		<footer class="footer">
			<div class="container">
				<p><center>LUTHFI NOER ARISA SIREGAR &copy; 2017 <p>
                   Www.Revo Owner Club Solo.Com</p>
			</div>
		</footer>
